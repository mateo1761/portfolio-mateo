...
import { privacyPolicyCopy } from '@/lib/privacy-policy-translations';
...
const copy = computed(() => privacyPolicyCopy[props.locale]);
const portfolioUrl = computed(() =>
    props.locale === 'es' ? home() : homeEn(),
);
const alternatePrivacyUrl = computed(() =>
    props.locale === 'es' ? privacyEn() : privacy(),
);
const canonicalUrl = computed(() =>
    props.locale === 'es' ? privacy.url() : privacyEn.url(),
);
</script>
